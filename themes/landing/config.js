const CONFIG = {
  ...
  LANDING_HEADER_BUTTON_1_URL: 'https://github.com/LeoYoung-code',

  LANDING_HEADER_BUTTON_2_TITLE: '作者博客',
  LANDING_HEADER_BUTTON_2_URL: 'https://github.com/LeoYoung-code',

  // 首页大图英雄板块
  LANDING_HERO_TITLE_1: 'NotionNext',
  LANDING_HERO_P_1: '快速搭建独立站、轻松放大品牌价值！',
  LANDING_HERO_BUTTON_1_TEXT: '开始体验',
  LANDING_HERO_BUTTON_1_LINK: 'https://github.com/LeoYoung-code',
  LANDING_HERO_BUTTON_2_TEXT: '了解更多',
  LANDING_HERO_BUTTON_2_LINK: 'https://github.com/LeoYoung-code',
  ...
  LANDING_POST_REDIRECT_URL: process.env.NEXT_PUBLIC_POST_REDIRECT_URL || 'https://blog-leoyoungcodes-projects.vercel.app', // 重定向网站地址
  ...
  LANDING_PRICING_1_URL: 'https://github.com/LeoYoung-code',
  ...
  LANDING_PRICING_2_URL: 'https://github.com/LeoYoung-code',
  ...
  LANDING_PRICING_3_URL: 'https://github.com/LeoYoung-code',
